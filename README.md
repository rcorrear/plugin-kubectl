...
This plugin replicates the functionality of the [Kubectl](https://github.com/robbyrussell/oh-my-zsh/tree/master/plugins/kubectl) plugin for [oh-my-zsh](http://ohmyz.sh/).
